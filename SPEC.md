...
Revocation and supersession do not edit the historical record. They are separate authenticated statements bound to the original record identifier and the declared status authority, naming the state, the reason, the effective time, and, for supersession, the replacement. Revocation and supersession are terminal for the original record; a replacement is a different verification record with its own identifier.
